    ...
    (error, results, fields) => {
        if (error) {
            ...
            const mailOptions = {
                ...
                html: `<h1 style="font-family: sans-serif;text-align: center; font-size: 20px;color: #3f3f3f;">Geachte meneer/mevrouw ${data.lastName},</h1><p style="text-align: center;font-family: sans-serif;">Hartelijk dan voor uw registratie bij RoosterIT. Om uw registratie te voltooien dient u uw account eerst te verifiëren.<br> Klik op de knop hier beneden om uw email-adres te verifiëren.</p><a class="button" href="http://localhost:3000/emailverificatie/${data.email}" style="display: block;text-align: center;width: 250px;; margin: auto;margin-top: 30px; vertical-align: middle;padding: 12px 24px;border: 1px solid #541c6f;border-radius: 100px;background: linear-gradient(to bottom, #af70cc, #541c6f);text-shadow: #321141 1px 1px 1px;font: normal normal bold 17px trebuchet ms;color: #ffffff;text-decoration: none;">Valideer account</a>`};
